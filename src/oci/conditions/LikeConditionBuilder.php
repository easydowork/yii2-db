...
namespace easydowork\db\oci\conditions;
...
class LikeConditionBuilder extends \easydowork\db\conditions\LikeConditionBuilder
{
     ...
     * we need to choose replacement value based on [[\easydowork\db\Schema::quoteValue()]].
     * {@inheritdoc}
     */
    ...
    public function build(ExpressionInterface $expression, array &$params = [])
    {
        if (!isset($this->escapingReplacements['\\'])) {
             ...
             * easydowork\db\Schema::quoteValue() may or may not quote \.
             */
