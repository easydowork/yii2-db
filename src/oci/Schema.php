...
namespace easydowork\db\oci;

use easydowork\db\base\InvalidCallException;
use easydowork\db\base\NotSupportedException;
use easydowork\db\CheckConstraint;
use easydowork\db\ColumnSchema;
use easydowork\db\Connection;
use easydowork\db\Constraint;
use easydowork\db\ConstraintFinderInterface;
...
use easydowork\db\helpers\ArrayHelper;
 ...
 * @since 2.0
 */
class Schema extends \easydowork\db\Schema implements ConstraintFinderInterface
{
     ...
     */
    public $exceptionMap = [
        'ORA-00001: unique constraint' => 'easydowork\db\IntegrityException',
    ];
...
SQL;
     ...
     * @internal param \easydowork\db\TableSchema $table->name the table schema
