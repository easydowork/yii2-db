...
class ColumnSchemaBuilder extends BaseObject
{
    ...
    /**
     * @var \easydowork\db\Connection the current database connection. It is used mainly to escape strings
     ...
     * @param \easydowork\db\Connection|null $db the current database connection. See [[$db]].
