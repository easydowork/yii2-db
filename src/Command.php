...
class Command extends BaseObject
{
     ...
     * @param array|\easydowork\db\Query $columns the column data (name => value) to be inserted into the table or instance
     ...
     * @param string $type the column type. [[\easydowork\db\QueryBuilder::getColumnType()]] will be called
     ...
     *
     * ```php
     * function (\easydowork\db\Exception $e, $attempt)
     * {
