...
abstract class Schema extends BaseObject
{
     ...
     */
    public $exceptionMap = [
        'SQLSTATE[23' => 'easydowork\db\IntegrityException',
    ];
    /**
     * @var string|array column schema class or class config
     * @since 2.0.11
     */
    public $columnSchemaClass = 'easydowork\db\ColumnSchema';
    ...
    {
        return ClassHelpers::createObject($this->columnSchemaClass);
    }
    ...
    public function convertException(\Exception $e, $rawSql)
    {
        ...
        $exceptionClass = '\easydowork\db\Exception';
     ...
     * @param bool $refresh whether to reload the table metadata
