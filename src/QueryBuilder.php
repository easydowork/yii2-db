...
use easydowork\db\conditions\ConditionInterface;
use easydowork\db\conditions\HashCondition;
use easydowork\db\helpers\StringHelper;
 ...
 * ```php ['LIKE' => easydowork\db\condition\LikeCondition::class] ``` .
 ...
 * @since 2.0
 */
class QueryBuilder extends \easydowork\db\base\BaseObject
{
    /**
     ...
     * ```php
     * return [
     *     'LIKE' => easydowork\db\condition\LikeCondition::class,
     * ];
     * ```
     *
     ...
     * ```php
     * [
     *    easydowork\db\Expression::class => easydowork\db\ExpressionBuilder::class
     * ]
     * ```
    ...
    {
        return [
            'NOT' => 'easydowork\db\conditions\NotCondition',
            'AND' => 'easydowork\db\conditions\AndCondition',
            'OR' => 'easydowork\db\conditions\OrCondition',
            'BETWEEN' => 'easydowork\db\conditions\BetweenCondition',
            'NOT BETWEEN' => 'easydowork\db\conditions\BetweenCondition',
            'IN' => 'easydowork\db\conditions\InCondition',
            'NOT IN' => 'easydowork\db\conditions\InCondition',
            'LIKE' => 'easydowork\db\conditions\LikeCondition',
            'NOT LIKE' => 'easydowork\db\conditions\LikeCondition',
            'OR LIKE' => 'easydowork\db\conditions\LikeCondition',
            'OR NOT LIKE' => 'easydowork\db\conditions\LikeCondition',
            'EXISTS' => 'easydowork\db\conditions\ExistsCondition',
            'NOT EXISTS' => 'easydowork\db\conditions\ExistsCondition',
        ];
    }
    ...
    {
        return [
            'easydowork\db\Query' => 'easydowork\db\QueryExpressionBuilder',
            'easydowork\db\PdoValue' => 'easydowork\db\PdoValueBuilder',
            'easydowork\db\Expression' => 'easydowork\db\ExpressionBuilder',
            'easydowork\db\conditions\ConjunctionCondition' => 'easydowork\db\conditions\ConjunctionConditionBuilder',
            'easydowork\db\conditions\NotCondition' => 'easydowork\db\conditions\NotConditionBuilder',
            'easydowork\db\conditions\AndCondition' => 'easydowork\db\conditions\ConjunctionConditionBuilder',
            'easydowork\db\conditions\OrCondition' => 'easydowork\db\conditions\ConjunctionConditionBuilder',
            'easydowork\db\conditions\BetweenCondition' => 'easydowork\db\conditions\BetweenConditionBuilder',
            'easydowork\db\conditions\InCondition' => 'easydowork\db\conditions\InConditionBuilder',
            'easydowork\db\conditions\LikeCondition' => 'easydowork\db\conditions\LikeConditionBuilder',
            'easydowork\db\conditions\ExistsCondition' => 'easydowork\db\conditions\ExistsConditionBuilder',
            'easydowork\db\conditions\SimpleCondition' => 'easydowork\db\conditions\SimpleConditionBuilder',
            'easydowork\db\conditions\HashCondition' => 'easydowork\db\conditions\HashConditionBuilder',
            'easydowork\db\conditions\BetweenColumnsCondition' => 'easydowork\db\conditions\BetweenColumnsConditionBuilder',
        ];
    }
     ...
     * of [[easydowork\db\Query|Query]] to perform INSERT INTO ... SELECT SQL statement.
     * Passing of [[easydowork\db\Query|Query]] is available since version 2.0.11.
    ...
    protected function prepareInsertValues($table, $columns, $params = [])
    {
        ...
        if ($columns instanceof Query) {
            ...
            foreach ($columns as $name => $value) {
                ...
                } elseif ($value instanceof \easydowork\db\Query) {
     ...
     * @param \easydowork\db\Schema $schema Schema object to quote column name.
     * @param array $params the parameters to be bound to the generated SQL statement. These parameters will
     * be included in the result with the additional parameters generated during the query building process.
     ...
     *     'visits' => 0,
     * ], [
     *     'visits' => new \easydowork\db\Expression('visits + 1'),
     * ], $params);
     * ```
     *
     * The method will properly escape the table and column names.
     ...
     * to instance of [[easydowork\db\condition\ConditionInterface|ConditionInterface]] according to
    ...
    public function createConditionFromArray($condition)
    {
        if (isset($condition[0])) { // operator format: operator, operand 1, operand 2, ...
            ...
            if (isset($this->conditionClasses[$operator])) {
                ...
                $className = 'easydowork\db\conditions\SimpleCondition';
            }
