...
namespace easydowork\db\cubrid;
...
class Schema extends \easydowork\db\Schema implements ConstraintFinderInterface
{
     ...
     */
    public $exceptionMap = [
        'Operation would have caused one or more unique constraint violations' => 'easydowork\db\IntegrityException',
    ];
     ...
     * @return \easydowork\db\ColumnSchema the column schema object
     */
