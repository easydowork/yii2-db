 ...
 * @since 2.0
 */
class QueryBuilder extends \easydowork\db\QueryBuilder
{
    /**
    ...
    protected function defaultExpressionBuilders()
    {
        return array_merge(parent::defaultExpressionBuilders(), [
            'easydowork\db\conditions\InCondition' => 'easydowork\db\mssql\conditions\InConditionBuilder',
            'easydowork\db\conditions\LikeCondition' => 'easydowork\db\mssql\conditions\LikeConditionBuilder',
        ]);
    }
     ...
     * @param array $orderBy the order by columns. See [[\easydowork\db\Query::orderBy]] for more details on how to specify this parameter.
     * @param int $limit the limit number. See [[\easydowork\db\Query::limit]] for more details.
     * @param int $offset the offset number. See [[\easydowork\db\Query::offset]] for more details.
     ...
     * @param string $sql the existing SQL (without ORDER BY/LIMIT/OFFSET)
     * @param array $orderBy the order by columns. See [[\easydowork\db\Query::orderBy]] for more details on how to specify this parameter.
     * @param int|Expression $limit the limit number. See [[\easydowork\db\Query::limit]] for more details.
     * @param int $offset the offset number. See [[\easydowork\db\Query::offset]] for more details.
     * @return string the SQL completed with ORDER BY/LIMIT/OFFSET (if any)
     */
    ...
    public function alterColumn($table, $column, $type)
    {
        ...
        if ($type instanceof \easydowork\db\mssql\ColumnSchemaBuilder) {
    ...
    protected function getAllColumnNames($modelClass = null)
    {
        ...
        /* @var $modelClass \easydowork\db\ActiveRecord */
     ...
     * @throws \easydowork\db\Exception
